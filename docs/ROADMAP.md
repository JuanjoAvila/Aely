...
> Estado a 2026-09-11 · **v4.19.63** — en pruebas: el banco a medio conectar avisa, y al quitarlo se va de Cartera.
...
| Qué | Valor |
|-----|--------|
| Web / OTA (`VERSION`) | **4.19.63** (repo; canal = `npm run salud`) |
