...
Estado actual: **v4.25.9** preparada para producción — cada posición de Inversiones muestra beneficio en euros y porcentaje sin inventarlo cuando faltan datos; disponibilidad del canal con `npm run salud`. Detalle en [docs/ROADMAP.md](docs/ROADMAP.md), [CHANGELOG.md](CHANGELOG.md) y [docs/ARQUITECTURA.md](docs/ARQUITECTURA.md).
