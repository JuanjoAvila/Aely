...
description: Backlog explícito de "para más adelante, no ahora" de Aely — UX de Ajustes, tutorial en secciones, cuenta compartida/familiar
metadata:
  type: project
