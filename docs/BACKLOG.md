...
| **UX-04 · sugerencias sin cierre fiable** | El relevo llamaba pendientes a dos sugerencias. **El mensaje al actualizar cuentas sí tiene fix documentado y código actual** (`bank_upd_one/n`); no rehacerlo. El acceso tocando la cartera superior sigue ambiguo; tocar avatar ya abre perfil. | Registrar el cierre del mensaje salvo feedback nuevo. Para el acceso superior, localizar pantalla/intención antes de proponer cambio; si sigue ambiguo, aclaración puntual al dueño. La mera presencia de feedback viejo en la tabla no significa que siga sin atender. |
| **UX-05 · doble filtro en Mis bancos** | Viejo backlog: probablemente cerrado por la tanda bancos aprobada, sin prueba específica del caso. | Inspección breve de la ruta actual y DOM. Si ya hay una sola selección coherente, registrar evidencia y cerrar; no rediseñar por una nota antigua. |
