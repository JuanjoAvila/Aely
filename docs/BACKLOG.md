...
| **FIN-07 · P1 · histórico cloud completo** | Beta 4.26.52.1 aprobada por el usuario; candidato exclusivo a producción 4.26.52, sin FIN-05 ni selector. | Publicación pendiente de Promote y Pages; [evidencia y contrato](briefs/fin07-historico-cloud-2026-09-26.md). Sin snapshot global; ausencia no borra. |
