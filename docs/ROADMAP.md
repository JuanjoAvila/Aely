...
> Estado a 2026-09-09 · **v4.19.15** — cada cuenta arrastra sus propios gastos al cerrar el mes.
> Anterior: v4.19.14 — revisión plegable y deshacer sin restaurar estado antiguo.
...
| Qué | Valor |
|-----|--------|
| Web / OTA (`VERSION`) | **4.19.15** (repo; canal = `npm run salud`) |
