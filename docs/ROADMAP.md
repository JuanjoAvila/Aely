...
> Estado a 2026-09-25 · **v4.26.49** preparada en la rama FIN-05, no publicada; producción sigue en 4.26.48 y APK 48. La Edge compartida y la APK nueva requieren revisión y autorización. Comprobar disponibilidad real con `npm run salud`.
...
| Qué | Valor |
|-----|--------|
| Web / OTA (`VERSION`) | **4.26.49** candidata FIN-05, sin publicar. Producción y beta siguen en 4.26.48. |
