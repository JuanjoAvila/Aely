...
| [#35](https://github.com/JuanjoAvila/Mi-Cartera/pull/35), efectivo → beta; [#36](https://github.com/JuanjoAvila/Mi-Cartera/pull/36), edit-link → rama de Claude | **Los dos redundantes, comprobado el 9/9.** #36: `git cherry origin/beta` no devuelve NADA — cero commits fuera de beta. #35: su único commit `fb52ee94` sale con `-`, o sea que beta ya tiene su parche equivalente. **Cerrables sin rescatar nada**, con el OK del dueño. Ojo: no reabrirlos encima de FIN-01, que toca justo el efectivo. |
