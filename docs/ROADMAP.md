...
> Estado a 2026-09-11 · **v4.19.45** — conectar cuentas también desde Cartera → Tus cuentas.
> Anterior: **v4.19.44** — logos de banco y tamaño de letra desde Inicio.
> Anterior: v4.19.33
...
| Qué | Valor |
|-----|--------|
| Web / OTA (`VERSION`) | **4.19.45** (repo; canal = `npm run salud`) |
