...
Estado actual: **v4.18.22** en el repo — disponibilidad del canal con `npm run salud`. Detalle en [docs/ROADMAP.md](docs/ROADMAP.md), [CHANGELOG.md](CHANGELOG.md) y [docs/ARQUITECTURA.md](docs/ARQUITECTURA.md).
...
- **Ordenar gastos del mismo día:** arrastra el asa ⠿ de la fila en Gastos; la fecha original no cambia.
- **Cartera:** el patrimonio cuenta al llegar y, mientras llega el primer dato, Inicio no muestra cifras provisionales.
