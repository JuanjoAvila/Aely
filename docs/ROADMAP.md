...
> Estado a 2026-09-10 · **v4.19.34** — sonda de duplicados del histórico (solo medida).
> Anterior: v4.19.33 — la app se llama Aely (Tanda A), Bizum con categoria y el vacio entra por onboarding.
> Anterior: v4.19.31
...
| Qué | Valor |
|-----|--------|
| Web / OTA (`VERSION`) | **4.19.34** (repo; canal = `npm run salud`) |
