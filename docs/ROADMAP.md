...
> Estado a 2026-09-11 · **v4.18.11** — porte manual de `categoria-ia` en `prod/categoria-ia`: los movimientos nuevos de herramientas de IA se clasifican por separado; el histórico no cambia. La paridad de la Edge está preparada en código, sin desplegar y pendiente de autorización del propietario.
