...
> Estado a 2026-09-11 · **v4.19.43** — en pruebas, el contador de bancos no inventa un TR fantasma.
> Anterior: **v4.19.43** — cuadro azul de Cuentas, onboarding y rebote en bloque.
> Anterior: v4.19.33
...
| Qué | Valor |
|-----|--------|
| Web / OTA (`VERSION`) | **4.19.43** (repo; canal = `npm run salud`) |
