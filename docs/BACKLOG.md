...
| **FIN-07 · P1 · histórico cloud completo** | Publicado solo en beta 4.26.52.1, código 94bca134 sobre d237478e. La base ya paginaba; corregidos fin por página corta, techo 50.000 y cursor de fecha editable. | Claude PASS y CI completo verde (Action 36255600639); prueba móvil y aprobación de producción pendientes. [Contrato y evidencia](briefs/fin07-historico-cloud-2026-09-26.md). Sin snapshot global; ausencia no borra. Límites bancarios y procedencia diaria por cuenta documentados aparte. |
