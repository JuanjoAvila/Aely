...
> Estado a 2026-09-14 · **v4.21.1** — la APK 46 (sin copia de Android ni token de ingest) ya en la calle; beta sigue con las cuotas de deudas.
...
| Qué | Valor |
|-----|--------|
| Web / OTA (`VERSION`) | **4.21.1** (repo; canal = `npm run salud`) |
