...
const LANG = {
  es:{
    ...
    help_banks_body:"Abre Mis bancos y reconecta si aparece un aviso.\nPulsa Actualizar una vez.\nRevisa el mes y el banco en Gastos; para meses anteriores usa Importar histórico.",
    help_cash:"Gastar en efectivo",
    help_cash_body:"Crea Efectivo en Cartera si aún no existe.\nAbre Apuntar en efectivo e indica la compra y el importe.\nGuarda con Efectivo seleccionado; el cajero no cuenta como compra.",
    help_categories:"Corregir una categoría",
    help_categories_body:"Abre el movimiento en Gastos.\nElige la categoría correcta.\nGuarda y revisa futuras sugerencias antes de aceptarlas.",
    help_debts:"Préstamos y cuotas",
    help_debts_body:"Abre Plan → Deudas.\nAñade el préstamo con su saldo y su cuota.\nVincula cada cobro solo una vez.",
    help_goals:"Ahorrar para una meta",
    help_goals_body:"Abre Plan → Metas.\nCrea la meta e indica el objetivo y la fecha.\nRevisa el ahorro mensual que le asignas.",
    ...
    help_history_body:"Abre Importar histórico.\nElige el banco y el periodo.\nRevisa cada movimiento antes de importarlo.",
    ...
    help_receipts_body:"Abre Plan → Recibos.\nRevisa lo pendiente y lo cobrado.\nSi falta un cargo antiguo, usa Importar histórico y no lo apuntes dos veces.",
    help_send:"Preguntar",
  ...
  en:{
    ...
    help_banks_body:"Open My banks and reconnect if a warning appears.\nTap Update once.\nCheck the month and bank in Spending; use Import history for earlier months.",
    help_cash:"Spend cash",
    help_cash_body:"Create Cash in Portfolio if it does not exist yet.\nOpen Record cash expense and enter the purchase and amount.\nSave with Cash selected; the ATM withdrawal is not the purchase.",
    help_categories:"Correct a category",
    help_categories_body:"Open the transaction in Spending.\nChoose the correct category.\nSave and review future suggestions before accepting them.",
    help_debts:"Loans and instalments",
    help_debts_body:"Open Plan → Debts.\nAdd the loan with its balance and instalment.\nLink each charge only once.",
    help_goals:"Save towards a goal",
    help_goals_body:"Open Plan → Goals.\nCreate the goal and enter its target and date.\nReview the monthly saving assigned to it.",
    ...
    help_history_body:"Open Import history.\nChoose the bank and period.\nReview every transaction before importing it.",
    ...
    help_receipts_body:"Open Plan → Bills.\nReview what is pending and what was paid.\nIf an old charge is missing, use Import history and do not record it twice.",
    help_send:"Ask",
  ...
  ca:{
    ...
    help_banks_body:"Obre Els meus bancs i reconnecta si apareix un avís.\nPrem Actualitzar una vegada.\nRevisa el mes i el banc a Despeses; per a mesos anteriors usa Importar històric.",
    help_cash:"Gastar en efectiu",
    help_cash_body:"Crea Efectiu a Cartera si encara no existeix.\nObre Apuntar en efectiu i indica la compra i l'import.\nDesa amb Efectiu seleccionat; el caixer no compta com a compra.",
    help_categories:"Corregir una categoria",
    help_categories_body:"Obre el moviment a Despeses.\nTria la categoria correcta.\nDesa i revisa els suggeriments futurs abans d'acceptar-los.",
    help_debts:"Préstecs i quotes",
    help_debts_body:"Obre Pla → Deutes.\nAfegeix el préstec amb el saldo i la quota.\nVincula cada càrrec una sola vegada.",
    help_goals:"Estalviar per a una meta",
    help_goals_body:"Obre Pla → Metes.\nCrea la meta i indica l'objectiu i la data.\nRevisa l'estalvi mensual que hi assignes.",
    ...
    help_history_body:"Obre Importar històric.\nTria el banc i el període.\nRevisa cada moviment abans d'importar-lo.",
    ...
    help_receipts_body:"Obre Pla → Rebuts.\nRevisa el que queda pendent i el que ja s'ha cobrat.\nSi falta un càrrec antic, usa Importar històric i no l'apuntis dues vegades.",
    help_send:"Preguntar",
...
Object.assign(LANG.es,{
  ...
  g_skip_posible:"tócalo: ¿mismo o distinto?", g_skip_deuda:"ya cuenta en el Plan", g_filters_debts:"Cuotas", g_cuota_de:"Es la cuota de…",
  ...
  g_filters_cat_none:"Ninguna activa", g_filters_cat_active_one:"{n} seleccionada", g_filters_cat_active:"{n} seleccionadas",
  ...
  g_card:"Con tarjeta", g_nocard:"Bizum o transferencia",
...
Object.assign(LANG.en,{
  ...
  g_skip_posible:"tap: same or different?", g_skip_deuda:"already in your Plan", g_filters_debts:"Your debt payments", g_cuota_de:"It’s the payment for…",
  ...
  g_filters_cat_none:"None active", g_filters_cat_active_one:"{n} selected", g_filters_cat_active:"{n} selected",
  ...
  g_card:"Card", g_nocard:"Bizum or transfer",
...
Object.assign(LANG.ca,{
  ...
  g_skip_posible:"toca'l: mateix o diferent?", g_skip_deuda:"ja compta al Pla", g_filters_debts:"Quotes dels teus deutes", g_cuota_de:"És la quota de…",
  ...
  g_filters_cat_none:"Cap activa", g_filters_cat_active_one:"{n} seleccionada", g_filters_cat_active:"{n} seleccionades",
  ...
  g_card:"Amb targeta", g_nocard:"Bizum o transferència",
...
Object.assign(LANG.es,{
  ...
  iv_percent:"{pct}% desde que empezaste · Actualizado {time}", iv_updated:"Actualizado {time}",
  iv_no_put:"Dime lo que pusiste y te diré cuánto han ganado.", iv_no_put_cta:"Añadir lo que puse", iv_where:"Dónde lo tienes",
...
Object.assign(LANG.en,{
  ...
  iv_percent:"{pct}% since you started · Updated {time}", iv_updated:"Updated {time}",
  iv_no_put:"Tell me what you put in and I'll show you how much they gained.", iv_no_put_cta:"Add what I put in", iv_where:"Where you keep them",
...
Object.assign(LANG.ca,{
  ...
  iv_percent:"{pct}% des que vas començar · Actualitzat {time}", iv_updated:"Actualitzat {time}",
  iv_no_put:"Digues-me què hi vas posar i et diré quant han guanyat.", iv_no_put_cta:"Afegir el que hi vaig posar", iv_where:"On ho tens",
  ...
  iv_add_manual:"Afegir una posició a mà", iv_broker:"Bróquer", iv_name:"Nom", iv_value_field:"Valor actual (€/$)", iv_cost_field:"El que hi vas posar (€/$)", iv_added:"✓ Posició afegida",
...
Object.assign(LANG.es,{
  ...
  gm_levelup:"🎉 ¡Subiste al nivel {n}!", gm_badge_new:"🏅 Logro: {x}",
...
Object.assign(LANG.en,{
  ...
  gm_levelup:"🎉 You reached level {n}!", gm_badge_new:"🏅 Achievement: {x}",
...
Object.assign(LANG.ca,{
  ...
  gm_levelup:"🎉 Has pujat al nivell {n}!", gm_badge_new:"🏅 Assoliment: {x}",
