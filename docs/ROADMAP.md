...
> Estado a 2026-09-11 · **v4.19.52** — en pruebas: los logos REALES de sus bancos y el rastro de los gastos que no suben.
...
| Qué | Valor |
|-----|--------|
| Web / OTA (`VERSION`) | **4.19.52** (repo; canal = `npm run salud`) |
