...
> Estado a 2026-09-22 · **v4.25.7** — Cyberpunk, Otoño y Primavera aprobados en beta y preparados como tanda independiente de producción, sin incorporar el resto de cambios 4.26.
...
| Qué | Valor |
|-----|--------|
| Web / OTA (`VERSION`) | **4.25.7** (repo; canal = `npm run salud`) |
