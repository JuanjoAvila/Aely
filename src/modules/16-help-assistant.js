...
function HelpAssistant({onClose,onAction,onConsent,online,signedIn,simple,hiddenTabs,hasCash,snap,helpAiOk,helpAiAsked}){
  ...
  useEffect(function(){
    ...
    // Abrir con el textarea enfocado levantaba el teclado y tapaba toda la explicación antes de
    // poder leerla. El diálogo conserva foco accesible en Volver; el teclado nace al tocar la caja.
    var first=root.querySelector('[data-act="back"]');
