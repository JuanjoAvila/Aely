...
> Estado a 2026-09-10 · **v4.19.33** — Bizum como categoría; el vacío vuelve a enseñar el onboarding.
> Anterior: v4.19.31 — deslizar despacio, sin temblor.
> Anterior: v4.19.30
...
| Qué | Valor |
|-----|--------|
| Web / OTA (`VERSION`) | **4.19.33** (repo; canal = `npm run salud`) |
