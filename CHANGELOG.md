...
- Cliente aprobado por el usuario el 26/9 para producción; candidato aislado sobre main, todavía sin publicar en producción. Cliente publicado como beta OTA 4.26.51.1 por Action 36242414362 (SHA f60df6f5), Claude PASS; 438 E2E + 7 rendimiento y Deno verdes en CI. Bundle, huella y sellos OTA/SW cotejados; producción continúa 4.26.48. Código servidor preparado y probado, SIN despliegue de backend compartido. FIN-05 y selector conservan sus pruebas móviles pendientes; sin promoción a main.
