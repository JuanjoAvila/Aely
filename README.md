...
Estado actual: **v4.26.46** en corrección tras beta — cambiar el día de un recibo ya cobrado conserva una sola ocurrencia y su fecha bancaria real; el día nuevo queda para próximos meses, sin mover saldos ni históricos. La APK 48 sigue vigente y producción sirve 4.25.20; disponibilidad real con `npm run salud`. Detalle en [docs/ROADMAP.md](docs/ROADMAP.md), [CHANGELOG.md](CHANGELOG.md) y [docs/ARQUITECTURA.md](docs/ARQUITECTURA.md).
