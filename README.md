...
Estado actual: **v4.26.16** preparada para beta — la pantalla completa de Inversiones entra desde la derecha y se puede cerrar con un gesto de borde que acompaña el dedo; producción continúa en 4.25.7 y no se ha tocado. Disponibilidad real de canales con `npm run salud`. Detalle en [docs/ROADMAP.md](docs/ROADMAP.md), [CHANGELOG.md](CHANGELOG.md) y [docs/ARQUITECTURA.md](docs/ARQUITECTURA.md).
