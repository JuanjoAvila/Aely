...
const LANG = {
  es:{
    ...
    v4_gastos_cats:"Por categoría", v4_gastos_cat_limit:"límite {x}", v4_gastos_cat_nolimit:"Sin límite · tocar para poner",
  ...
  en:{
    ...
    v4_gastos_cats:"By category", v4_gastos_cat_limit:"limit {x}", v4_gastos_cat_nolimit:"No limit · tap to set",
  ...
  ca:{
    ...
    v4_gastos_cats:"Per categoria", v4_gastos_cat_limit:"límit {x}", v4_gastos_cat_nolimit:"Sense límit · toca per posar",
