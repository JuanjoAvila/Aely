...
| **FIN-05 · P1 · widget con app cerrada** | **Candidata 4.26.49 en rama, no publicada.** Árbitro Java, lectura mensual sellada en Edge y reentrada tras pull implementados; Claude dio PASS a `e1168c6d`. APK 4.26.49/code 50 firmada y verificada solo en dry-run local: no subida ni instalada. Falta autorización para Edge compartida, entrega beta de APK y prueba en móvil; [relevo exacto](briefs/fin05-widget-arbitraje-2026-09-26.md). OPS-01 sigue abierto: el último deploy observado no demuestra el código activo actual. Pendientes anteriores sin marca remota pueden seguir contando en servidor. | Ensayo de dos escritores con orden de respuestas invertido; comparar presupuesto, disponible y saldo por banco con las mismas filas. Probar además mes/día nuevos, app cerrada y reentrada. Verificar servidor realmente desplegado (OPS-01). Si cambia contrato/Java, APK nueva. No declarar resuelto por un E2E de resume. |
