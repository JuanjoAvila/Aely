...
> Estado a 2026-09-26 · **v4.26.53** candidato TR: clasificar entradas nuevas con concepto/MCC opcionales, conservando identidad e histórico. Pendiente de revisión/publicación y autorización de bank-sync compartido. Producción verificada previamente 4.26.52 (FIN-07); beta 4.26.52.1 conserva FIN-05/selector pendientes. APK beta 4.26.49/code 50, estable 4.26.32/code 48. FIN-06 cliente aprobado; sin backend ni APK nuevos.
...
| Qué | Valor |
|-----|--------|
| Web / OTA (`VERSION`) | **4.26.53** candidato TR sin publicar; producción verificada previamente 4.26.52/main 8cd41f09, beta 4.26.52.1 conserva pendientes FIN-05/selector. |
