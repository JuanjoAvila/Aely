...
const LANG = {
  es:{
    ...
    v4_streak:"{n} meses sin pasarte", v4_hist_empty:"Tu histórico empieza hoy", v4_nobud_t:"Ponle un presupuesto", v4_nobud_p:"Es la mitad de la app: sin un tope al mes no se puede saber cuánto te queda. Puedes cambiarlo cuando quieras.", v4_nobud_cta:"Ponle un presupuesto", v4_see_gastos:"Ver gastos ›", v4_see_plan:"Ver plan ›",
  ...
  en:{
    ...
    v4_streak:"{n} months on track", v4_hist_empty:"Your history starts today", v4_nobud_t:"Set a monthly budget", v4_nobud_p:"It is half the app: without a monthly cap there is no way to know what you have left. You can change it whenever you want.", v4_nobud_cta:"Set a budget", v4_see_gastos:"See spending ›", v4_see_plan:"See plan ›",
  ...
  ca:{
    ...
    v4_streak:"{n} mesos sense passar-te", v4_hist_empty:"El teu històric comença avui", v4_nobud_t:"Posa-li un pressupost", v4_nobud_p:"És la meitat de l'app: sense un límit al mes no es pot saber quant et queda. El pots canviar quan vulguis.", v4_nobud_cta:"Posa-li un pressupost", v4_see_gastos:"Veure despeses ›", v4_see_plan:"Veure pla ›",
