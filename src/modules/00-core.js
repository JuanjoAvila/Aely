...
/* ============================================================
   ...
   Se compara POR PALABRAS, no con expresiones regulares: un `` perdido al copiar un fichero
   convierte «AMD» en algo que casa dentro de cualquier palabra, y aquí un fallo callado es
   ponerle a una empresa la cara de otra. Ante la duda, SIN logo: el monograma correcto es
   mejor que el logotipo equivocado.
   ============================================================ */
