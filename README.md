...
Estado actual: **v4.26.27** preparada para beta — «Paso a paso» muestra tres instrucciones cortas y numeradas, sin separadores visibles ni párrafos largos. Producción sirve 4.25.9 con el beneficio aprobado en euros y porcentaje; disponibilidad real con `npm run salud`. Detalle en [docs/ROADMAP.md](docs/ROADMAP.md), [CHANGELOG.md](CHANGELOG.md) y [docs/ARQUITECTURA.md](docs/ARQUITECTURA.md).
