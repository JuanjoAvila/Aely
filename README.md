...
Estado actual: **v4.26.8** en el repo — Plan v4.1 usa importes reales, saldos honestos y recibos accesibles, aún sin publicar; disponibilidad de canales con `npm run salud`. Detalle en [docs/ROADMAP.md](docs/ROADMAP.md), [CHANGELOG.md](CHANGELOG.md) y [docs/ARQUITECTURA.md](docs/ARQUITECTURA.md).
