...
> Estado a 2026-09-25 · **v4.26.48** disponible en beta: al añadir en Recibos, una confirmación indica tipo y nombre. Producción sigue en 4.26.47 tras la aprobación móvil de 4.26.47.1. La APK 48 sigue vigente; comprobar disponibilidad real con `npm run salud`.
...
| Qué | Valor |
|-----|--------|
| Web / OTA (`VERSION`) | **4.26.48** (beta; confirmación al añadir en Recibos). Producción: 4.26.47. |
