...
Object.assign(LANG.es,{
  ...
  bp_hist_nuevos:"nuevos", bp_hist_repes:"repetidos", bp_hist_probe:"Sonda: banco {bank} · llegan {llegan} · nuevos {nuevos} · ya existían {ya}", bp_hist_dupexist:"ya lo tienes apuntado (mismo día e importe)",
...
Object.assign(LANG.en,{
  ...
  bp_hist_nuevos:"new", bp_hist_repes:"repeated", bp_hist_probe:"Probe: bank {bank} · arrive {llegan} · new {nuevos} · already there {ya}", bp_hist_dupexist:"already logged (same day & amount)",
...
Object.assign(LANG.ca,{
  ...
  bp_hist_nuevos:"nous", bp_hist_repes:"repetits", bp_hist_probe:"Sonda: banc {bank} · arriben {llegan} · nous {nuevos} · ja existien {ya}", bp_hist_dupexist:"ja ho tens apuntat (mateix dia i import)",
