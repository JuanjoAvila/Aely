...
export const CATEGORIAS: Record<string, string[]> = {
  ...
  /* AGUA / LUZ / GAS. Espejo EXACTO de `00-core.js` y en el MISMO orden: `agua` va primera para
     que lo específico gane a lo genérico, y las ambiguas (Naturgy/Endesa/…) caen en `luz`.
     El guardián `categorias-dual` saca las palabras de AQUÍ y exige que las dos partes
     clasifiquen igual, así que las dos listas se tocan a la vez o se pone rojo. */
  ...
  salud:      ["farmacia","fcia","clinica","medico","dentista","hospital","optica","fisio","masaje","sanitas","adeslas","asisa","dkv","mutua","quiron","vitaldent","promofarma","dosfarma","laboratorio","analisis","urgencias"],
