...
Estado actual: **v4.25.7** en el repo — Cyberpunk, Otoño y Primavera en Ajustes → Apariencia; disponibilidad del canal con `npm run salud`. Detalle en [docs/ROADMAP.md](docs/ROADMAP.md), [CHANGELOG.md](CHANGELOG.md) y [docs/ARQUITECTURA.md](docs/ARQUITECTURA.md).
