...
| **Widget · elección de tarjeta/cuenta · petición 26/9** | Al usuario le aparece CaixaBank en «Puedes gastar en» y quiere poder elegir otra tarjeta o cuenta. Tarea separada de FIN-05, retomada el 26/9 en rama `codex/widget-banco-26sep`, candidata 4.26.50. Selector por banco implementado en Ajustes; 6 E2E dirigidos y árbitro Java verdes, condiciones de revisión Claude satisfechas; pendiente beta/CI y veredicto móvil. [Relevo](briefs/widget-banco-2026-09-26.md). | Comprobar primero si ya existe un selector y dónde se guarda; permitir la elección explícita, persistirla y verificar qué muestra el widget en móvil. Mantener separados el banco mostrado y los cálculos de presupuesto/saldo para no inventar ni duplicar importes. Beta antes de producción y `main` solo con aprobación. |
