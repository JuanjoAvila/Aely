...
> Estado a 2026-09-10 · **v4.19.39** — Aely se presenta: copy del brief, logo medido sobre el original e icono nativo.
> Anterior: v4.19.33
...
| Qué | Valor |
|-----|--------|
| Web / OTA (`VERSION`) | **4.19.39** (repo; canal = `npm run salud`) |
