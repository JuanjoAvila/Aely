...
Estado actual: **v4.26.48** en producción — Recibos confirma el tipo y nombre de cada alta. La APK 48 sigue vigente. Disponibilidad real con `npm run salud`. Detalle en [docs/ROADMAP.md](docs/ROADMAP.md), [CHANGELOG.md](CHANGELOG.md) y [docs/ARQUITECTURA.md](docs/ARQUITECTURA.md).
