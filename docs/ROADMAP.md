...
> Estado a 2026-09-24 · **v4.26.35** preparada para beta — el filtro de Gastos usa las mismas fichas de icono y nombre que Apuntar y Modificar, conservando plegado, búsqueda y multiselección. La APK 48 sigue vigente para el gesto Atrás nativo. Producción sirve 4.25.11 con el editor de presupuesto aprobado; comprobar disponibilidad real con `npm run salud`.
...
| Qué | Valor |
|-----|--------|
| Web / OTA (`VERSION`) | **4.26.35** (selector visual de categorías en Gastos, preparada para beta; canal real = `npm run salud`) |
