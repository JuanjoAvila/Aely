...
> Estado a 2026-09-11 · **v4.18.13** — en Gastos puedes ordenar manualmente los movimientos del mismo día sin cambiar su fecha.
...
| Qué | Valor |
|-----|--------|
| Web / OTA (`VERSION`) | **4.18.13** (repo; canal = `npm run salud`) |
