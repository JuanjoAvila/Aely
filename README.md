...
Estado actual: **v4.26.11** preparada para beta — Ajustes se abre sin salto al deslizar; los temas Cyberpunk, Otoño y Primavera siguen como tanda separada. Disponibilidad real de canales con `npm run salud`. Detalle en [docs/ROADMAP.md](docs/ROADMAP.md), [CHANGELOG.md](CHANGELOG.md) y [docs/ARQUITECTURA.md](docs/ARQUITECTURA.md).
