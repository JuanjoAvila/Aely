...
Estado actual: **v4.26.49** preparada en la rama FIN-05; producción sigue en 4.26.48. El widget espera los gastos nuevos al volver a abrir la app y ordena las notificaciones tardías. La APK 48 sigue vigente; el cambio nativo requiere otra APK. Disponibilidad real con `npm run salud`. Detalle en [docs/ROADMAP.md](docs/ROADMAP.md), [CHANGELOG.md](CHANGELOG.md) y [docs/ARQUITECTURA.md](docs/ARQUITECTURA.md).
