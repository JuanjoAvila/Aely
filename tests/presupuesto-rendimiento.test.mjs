...
const PRESUPUESTO = {
  /* SUBIDO 5 KB el 2026-09-11, con motivo. A las dos tandas aprobadas ya portadas se suma la
     cabecera plegable de revisión, sus tres traducciones y su regresión. El minificado medido
     queda en 1207 KB; se dejan ~1 KB de aire, sin mover el límite gzip que sí mide la descarga.
     Producción todavía lleva las notas de versión DENTRO del módulo; el recorte a JSON aparte
     —que en beta deja el gzip en 318— es otra tanda y sube por su cuenta. Meterlo aquí sería
     ampliar un parche de emergencia con superficie que nadie ha aprobado. Medido tras el porte:
     1207 min / 342 gzip. Cuando suba el recorte de notas, estos topes BAJAN, no se quedan. */
  minificado: 1208 * 1024,
