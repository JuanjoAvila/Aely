...
Estado actual: **v4.25.15** preparada para producción — Bizum y transferencia son formas de pago separadas de la categoría real; el histórico se conserva y se corrige uno a uno, sin adivinar. Disponibilidad del canal con `npm run salud`. Detalle en [docs/ROADMAP.md](docs/ROADMAP.md), [CHANGELOG.md](CHANGELOG.md) y [docs/ARQUITECTURA.md](docs/ARQUITECTURA.md).
