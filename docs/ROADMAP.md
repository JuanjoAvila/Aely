...
> Estado a 2026-09-17 · **v4.26.6** — histórico aislado por banco y deduplicación estable TR/Wallet; nada publicado ni desplegado.
...
| Qué | Valor |
|-----|--------|
| Web / OTA (`VERSION`) | **4.26.6** (repo, sin publicar; canal = `npm run salud`) |
