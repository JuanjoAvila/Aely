...
Estado actual: **v4.26.35** preparada para beta — el filtro de Gastos usa las mismas fichas de categoría que Apuntar y Modificar, sin perder el plegado, la búsqueda ni la selección múltiple. La APK 48 sigue siendo la vigente para el gesto Atrás nativo. Producción sirve 4.25.10 con Ahorro mensual en Metas; disponibilidad real con `npm run salud`. Detalle en [docs/ROADMAP.md](docs/ROADMAP.md), [CHANGELOG.md](CHANGELOG.md) y [docs/ARQUITECTURA.md](docs/ARQUITECTURA.md).
