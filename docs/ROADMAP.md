...
> Estado a 2026-09-09 · **v4.19.17** — el histórico ya no descarta pagos de meses distintos, y el aviso de recibos fijos cuenta bien.
...
| Qué | Valor |
|-----|--------|
| Web / OTA (`VERSION`) | **4.19.17** (repo; canal = `npm run salud`) |
