...
> Estado a 2026-09-11 · **v4.18.22** — porte aislado del pulido B2/B4/B5: cuenta de Cartera, siluetas de inicio y contraste en tema claro. Pendiente de revisión y publicación.
...
| Qué | Valor |
|-----|--------|
| Web / OTA (`VERSION`) | **4.18.22** (repo; canal = `npm run salud`) |
