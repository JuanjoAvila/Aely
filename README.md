...
Estado actual: **v4.18.17** en el repo — disponibilidad del canal con `npm run salud`. Detalle en [docs/ROADMAP.md](docs/ROADMAP.md), [CHANGELOG.md](CHANGELOG.md) y [docs/ARQUITECTURA.md](docs/ARQUITECTURA.md).
...
- **Inicio y Apuntar:** el anillo del presupuesto se anima al entrar y las teclas de Apuntar son más grandes.
