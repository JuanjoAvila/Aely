...
| **FIN-05 · P1 · widget con app cerrada** | **Beta OTA 4.26.49.1 y APK prerelease 4.26.49/code 50 publicadas, sin promoción a producción.** Árbitro Java, lectura mensual sellada en Edge y reentrada tras pull implementados; Claude dio PASS a `e1168c6d`. Beta Action 36195486950 verde; Edge compartida `ingest` desplegada sola desde `be59e27c` por Action 36196554737, sin migraciones nuevas. APK firmada y verificada, sin instalar/probar en móvil; [relevo exacto](briefs/fin05-widget-arbitraje-2026-09-26.md). OPS-01 sigue abierto: un Action verde no demuestra por sí solo el código activo actual. Pendientes anteriores sin marca remota pueden seguir contando en servidor. | Ensayo de dos escritores con orden de respuestas invertido; comparar presupuesto, disponible y saldo por banco con las mismas filas. Probar además mes/día nuevos, app cerrada y reentrada. Verificar servidor realmente desplegado (OPS-01). Si cambia contrato/Java, APK nueva. No declarar resuelto por un E2E de resume. |
| **Widget · elección de tarjeta/cuenta · petición 26/9** | Al usuario le aparece CaixaBank en «Puedes gastar en» y quiere poder elegir otra tarjeta o cuenta. Tarea separada de FIN-05, retomada el 26/9 en rama `codex/widget-banco-26sep`, candidata 4.26.50. Selector por banco implementado en Ajustes; 6 E2E dirigidos y árbitro Java verdes; Claude PASS a f3960dd0. Beta 4.26.50.1 publicada por Action 36237247665 verde, bundle público verificado; pendiente veredicto móvil. [Relevo](briefs/widget-banco-2026-09-26.md). | Comprobar primero si ya existe un selector y dónde se guarda; permitir la elección explícita, persistirla y verificar qué muestra el widget en móvil. Mantener separados el banco mostrado y los cálculos de presupuesto/saldo para no inventar ni duplicar importes. Beta antes de producción y `main` solo con aprobación. |
| **FIN-06 · P1 · divisa sin cambio** · **Cliente aprobado y publicado exclusivamente en producción 4.26.51; servidor pendiente** | Reproducido sobre 9520bdaa y corregido en `codex/fin06-divisas`: originales/ISO visibles, aviso de total incompleto y exclusión de euros desconocidos; catálogo BCE 30 divisas, USD de respaldo guardado y céntimos alineados. Claude PASS f60df6f5; CI Action 36242414362 verde: unitarios + 4 ficheros Deno, 438 E2E y 7 rendimiento (1 omitido). Bundle HTTP 200, huella y sellos cotejados. [Relevo](briefs/fin06-divisas-2026-09-26.md). FIN-05 y selector conservan sus veredictos móviles pendientes. | Guion móvil aprobado el 26/9. Producción exclusiva verificada: merge 2ea992b2, Promote 36251080004 y Pages 36251710852 verdes; 430 E2E + 7 rendimiento, HTML/SW/ZIP cotejados. Backend preparado en `_shared/wallet.ts`, sin desplegar: requiere autorización específica de ingest. Móvil sin compra, producción solo con aprobación. Sin migraciones ni cambios retroactivos de movimientos. |
...
| **FIN-08 · P1 · daños históricos previos** | **Diagnóstico y propuesta revisados el 26/9: Claude real PASS e482c200; sin reparación real ni publicación visible.** [Mecanismos, reproducciones y plan](briefs/fin08-danos-historicos-2026-09-26.md), base beta 8bf229d4/main 91c5a4f4: colapso/mezcla de campos por clave débil y lápidas amplias aún actuales; DELETE/retirada por similitud anteriores a 4.18.6 reproducidos, hoy contenidos en esas rutas; recategorizaciones y rechazo de altas separados. No prueba pérdidas individuales; no hay evidencia privada original inspeccionada ni inventario real. | Siguiente decisión única: aceptar propuesta y autorizar, si procede, inventario privado **solo lectura** de fuentes/copias concretas, mediante sesión/export del propietario y ubicación fuera de repo/canal. Plan por UUID/campo exige identidad FIN-03, ACK/conflictos FIN-04 y copia/rollback cloud-local ensayados OPS-02; FIN-07 cerrado no resuelve esos límites. Sumatoria no demuestra identidad. Toda reparación real requiere aprobación posterior del plan exacto; cero migración/backfill/import familiar automático. |
