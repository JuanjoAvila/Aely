...
function helpCashWantsAccounts(question){
  ...
  if(/\b(apunt\w*|gast\w*|compr\w*|pag\w*|sac\w*|retir\w*|treur\w*|record\w*|spend\w*|spent|purchas\w*|expens\w*|bought|buy\w*|despes\w*|withdraw\w*|cajero|caixer|atm|billete|moneda)/.test(q)) return false;
