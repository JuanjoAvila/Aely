...
> Estado a 2026-09-24 · **v4.26.40** preparada para beta — Pregúntame respeta la zona segura con teclado, se recoloca sin rebote y oculta el indicador lateral. La APK 48 sigue vigente y producción sirve 4.25.11; comprobar disponibilidad real con `npm run salud`.
...
| Qué | Valor |
|-----|--------|
| Web / OTA (`VERSION`) | **4.26.40** (Pregúntame respeta teclado y zona segura, preparada para beta; canal real = `npm run salud`) |
