...
> Estado a 2026-09-10 · **v4.19.26** — panel de pruebas de uno en uno, modo inicial arreglado, pulsación larga y desglose plegable.
> Anterior: v4.19.22 — B2 count-up Cartera, esqueletos B4, tema claro B5.
...
| Qué | Valor |
|-----|--------|
| Web / OTA (`VERSION`) | **4.19.26** (repo; canal = `npm run salud`) |
