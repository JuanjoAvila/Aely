...
Estado actual: **v4.26.51** candidata a producción FIN-06 aprobada por el usuario: originales/ISO y totales incompletos sin cambio; 30 divisas y caché offline. Producción sigue 4.26.48 mientras se verifica la promoción. Beta 4.26.51.1; APK de producción 4.26.32/code 48, sin cambio nativo. Solo FIN-06; FIN-05 y selector siguen pendientes en beta. Servidor preparado, sin desplegar. [Relevo](docs/briefs/fin06-divisas-2026-09-26.md).
