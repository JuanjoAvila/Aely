...
Estado actual: **v4.26.28** preparada para beta — Inicio deja de presentar como ganancia mensual una cifra sin base fiable y la racha usa presupuestos guardados de meses cerrados. La 4.26.27 conserva el paso a paso breve y numerado del Asistente. Producción sirve 4.25.9 con el beneficio aprobado en euros y porcentaje; disponibilidad real con `npm run salud`. Detalle en [docs/ROADMAP.md](docs/ROADMAP.md), [CHANGELOG.md](CHANGELOG.md) y [docs/ARQUITECTURA.md](docs/ARQUITECTURA.md).
