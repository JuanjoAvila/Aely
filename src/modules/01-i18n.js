...
const LANG = {
  es:{
    help_title:"Ayuda de Aely",
    help_intro:"Escribe qué quieres hacer o elige un tema. Te guío paso a paso y abro la pantalla para que lo revises tú.",
    help_question:"¿En qué necesitas ayuda?",
    help_placeholder:"Por ejemplo: ¿cómo apunto una comida pagada en efectivo?",
    help_send:"Ver guía",
    help_local:"Guía disponible sin conexión.",
    help_unknown:"No he identificado la duda con suficiente claridad. Elige uno de los temas o explica qué intentabas hacer y en qué pantalla.",
    help_ai_matched:"La IA ha encontrado estas guías de Aely.",
    help_unavailable:"No se pudo consultar la IA. Puedes seguir usando las guías de arriba.",
  ...
  en:{
    help_title:"Aely help",
    help_intro:"Write what you want to do or choose a topic. I will guide you and open the screen for you to review.",
    help_question:"What do you need help with?",
    help_placeholder:"For example: how do I record a meal paid in cash?",
    help_send:"Show guide",
    help_local:"Guide available offline.",
    help_unknown:"I could not identify the question clearly enough. Choose a topic or describe what you were trying to do and on which screen.",
    help_ai_matched:"AI found these Aely guides.",
    help_unavailable:"AI is unavailable. You can still use the guides above.",
  ...
  ca:{
    help_title:"Ajuda d’Aely",
    help_intro:"Escriu què vols fer o tria un tema. Et guio pas a pas i obro la pantalla perquè ho revisis tu.",
    help_question:"En què necessites ajuda?",
    help_placeholder:"Per exemple: com apunto un àpat pagat en efectiu?",
    help_send:"Veure la guia",
    help_local:"Guia disponible sense connexió.",
    help_unknown:"No he identificat el dubte amb prou claredat. Tria un tema o explica què intentaves fer i en quina pantalla.",
    help_ai_matched:"La IA ha trobat aquestes guies d’Aely.",
    help_unavailable:"No s’ha pogut consultar la IA. Pots continuar fent servir les guies de dalt.",
...
Object.assign(LANG.es,{
  ...
  ai_cat_unavailable:"No se pudo consultar la sugerencia. Inténtalo más tarde o elige la categoría.",
  ai_cat_limited:"Has alcanzado el límite temporal de sugerencias. Prueba más tarde o elige la categoría.",
  ai_cat_rules_unavailable:"No se pudieron leer tus categorías guardadas. Inténtalo más tarde.",
  ai_cat_personal_other:"Tienes guardado «Otros» para este comercio. Puedes elegir otra categoría a mano.",
...
Object.assign(LANG.en,{
  ...
  ai_cat_unavailable:"The suggestion could not be retrieved. Try again later or choose a category.",
  ai_cat_limited:"You have reached the temporary suggestion limit. Try again later or choose a category.",
  ai_cat_rules_unavailable:"Your saved categories could not be read. Try again later.",
  ai_cat_personal_other:"You have saved “Other” for this merchant. You can choose a different category by hand.",
...
Object.assign(LANG.ca,{
  ...
  ai_cat_unavailable:"No s'ha pogut consultar el suggeriment. Torna-ho a provar més tard o tria la categoria.",
  ai_cat_limited:"Has arribat al límit temporal de suggeriments. Prova-ho més tard o tria la categoria.",
  ai_cat_rules_unavailable:"No s'han pogut llegir les teves categories desades. Torna-ho a provar més tard.",
  ai_cat_personal_other:"Tens desat «Altres» per a aquest comerç. Pots triar una altra categoria a mà.",
