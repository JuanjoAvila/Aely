...
Estado actual: **v4.26.13** preparada para beta — los candados desaparecen de la interfaz sin retirar ninguna protección; producción continúa en 4.25.7 y no se ha tocado. Disponibilidad real de canales con `npm run salud`. Detalle en [docs/ROADMAP.md](docs/ROADMAP.md), [CHANGELOG.md](CHANGELOG.md) y [docs/ARQUITECTURA.md](docs/ARQUITECTURA.md).
