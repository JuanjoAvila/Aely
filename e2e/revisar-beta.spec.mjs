...
test("con producción conocida, la checklist reúne la ronda entera", async ({ page }) => {
  ...
  const r = await page.evaluate(() => {
    ...
    RELEASE_NOTES.push(
      { v: "4.18.14", t: "Actual", tandas: [{ id: "actual", t: "Actual", items: { es: ["Actual"] } }] },
      { v: "4.18.13", t: "Anterior", tandas: [{ id: "anterior", t: "Anterior", items: { es: ["Anterior"] } }] },
      { v: "4.18.8", t: "Producción", tandas: [{ id: "prod", t: "Producción", items: { es: ["Producción"] } }] }
    );
    const solo = betaChecklist("4.18.14");
    const ronda = betaChecklist("4.18.14", "4.18.8");
    RELEASE_NOTES.length = 0;
  ...
  expect(r.ronda).toEqual(["4.18.14/actual", "4.18.13/anterior"]);
