...
Estado actual: **v4.26.6** en el repo — histórico bancario aislado por banco y deduplicación estable de notificaciones, aún sin publicar; disponibilidad de canales con `npm run salud`. Detalle en [docs/ROADMAP.md](docs/ROADMAP.md), [CHANGELOG.md](CHANGELOG.md) y [docs/ARQUITECTURA.md](docs/ARQUITECTURA.md).
...
- **Tus recibos v4.1 (en desarrollo):** Plan → Recibos → Gestionar abre una pantalla propia con buscador, grupos, fichas y alta por pasos; la comparación con el banco vive en Ajustes → Mis bancos.
