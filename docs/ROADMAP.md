...
> Estado a 2026-09-24 · **v4.26.45** preparada para beta — las cuotas nombran su deuda y dejan de duplicarse como una categoría de consumo, sin tocar cálculos ni históricos. La APK 48 sigue vigente y producción sirve 4.25.16; comprobar disponibilidad real con `npm run salud`.
...
| Qué | Valor |
|-----|--------|
| Web / OTA (`VERSION`) | **4.26.45** (cuotas separadas de las categorías de consumo, preparada para beta; canal real = `npm run salud`) |
