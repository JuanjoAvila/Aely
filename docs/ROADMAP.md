...
> Estado a 2026-09-25 · **v4.26.48** en producción: al añadir en Recibos, una confirmación indica tipo y nombre. El dueño aprobó la beta 4.26.48.1; la APK 48 sigue vigente. Comprobar disponibilidad real con `npm run salud`.
...
| Qué | Valor |
|-----|--------|
| Web / OTA (`VERSION`) | **4.26.48** en producción (confirmación al añadir en Recibos). Beta 4.26.48.1 alineada. |
