...
> Estado a 2026-09-23 · **v4.26.15** preparada para beta — «Actualizar inversiones» consulta brókers y precios y conserva los fallos parciales en un único aviso; producción continúa en 4.25.7 y no se ha tocado. Comprobar disponibilidad real con `npm run salud`.
...
| Qué | Valor |
|-----|--------|
| Web / OTA (`VERSION`) | **4.26.15** (preparada para beta; canal real = `npm run salud`) |
