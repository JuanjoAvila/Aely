...
> Estado a 2026-09-24 · **v4.26.34** preparada para beta — Pregúntame, Apuntar y las fichas de Gastos comparten una entrada y salida más pausada y continua, sin ralentizar el modo de movimiento reducido. La APK 48 sigue vigente para el gesto Atrás nativo. Producción sirve 4.25.9; comprobar disponibilidad real con `npm run salud`.
...
| Qué | Valor |
|-----|--------|
| Web / OTA (`VERSION`) | **4.26.34** (hojas con movimiento más pausado, preparada para beta; canal real = `npm run salud`) |
