...
Estado actual: **v4.25.8** preparada para producción — Ajustes abre sin salto desde el borde y los candados dibujados desaparecen sin retirar ninguna protección; disponibilidad del canal con `npm run salud`. Detalle en [docs/ROADMAP.md](docs/ROADMAP.md), [CHANGELOG.md](CHANGELOG.md) y [docs/ARQUITECTURA.md](docs/ARQUITECTURA.md).
