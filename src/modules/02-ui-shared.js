...
function bankMark(id){
  ...
  if(id==="myinvestor"){
    /* Blanco: «my» negro fino + barrita violeta a la derecha (sin círculo). */
    return {bg:"#FFFFFF",scale:0.78,el:React.createElement(React.Fragment,null,
      React.createElement("text",{x:10.2,y:15.4,textAnchor:"middle",fill:"#1a1a1a",
        fontSize:10.2,fontWeight:600,fontFamily:"system-ui,-apple-system,sans-serif",letterSpacing:"-0.8px"},"my"),
      React.createElement("defs",null,
        React.createElement("linearGradient",{id:"miBar",x1:"0",y1:"0",x2:"0.35",y2:"1"},
      ...
      React.createElement("path",{d:"M16.9 6.2 L18.05 6.8 L15.6 17.6 L14.45 17",fill:"url(#miBar)"})
    )};
  }
  if(id==="caixabank"){
