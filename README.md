...
Estado actual: **v4.26.11** preparada para beta — Ajustes se abre sin salto al deslizar; los temas Cyberpunk, Otoño y Primavera ya están aprobados en producción 4.25.7. Disponibilidad real de canales con `npm run salud`. Detalle en [docs/ROADMAP.md](docs/ROADMAP.md), [CHANGELOG.md](CHANGELOG.md) y [docs/ARQUITECTURA.md](docs/ARQUITECTURA.md).
