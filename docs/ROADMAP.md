...
> Estado a 2026-09-11 · **v4.18.17** — porte aislado de acabado v4: anillo de presupuesto, teclado de Apuntar y continuidad visible en carruseles. Pendiente de revisión y publicación.
...
| Qué | Valor |
|-----|--------|
| Web / OTA (`VERSION`) | **4.18.17** (repo; canal = `npm run salud`) |
