...
> Estado a 2026-09-10 · **v4.19.38** — Aely se presenta: copy del brief, logo medido sobre el original e icono nativo.
> Anterior: v4.19.33
...
| Qué | Valor |
|-----|--------|
| Web / OTA (`VERSION`) | **4.19.38** (repo; canal = `npm run salud`) |
