...
Estado actual: **v4.26.10** preparada para beta — nuevo tema Cyberpunk y temáticas Otoño y Primavera; disponibilidad real de canales con `npm run salud`. Detalle en [docs/ROADMAP.md](docs/ROADMAP.md), [CHANGELOG.md](CHANGELOG.md) y [docs/ARQUITECTURA.md](docs/ARQUITECTURA.md).
