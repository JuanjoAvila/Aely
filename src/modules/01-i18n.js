...
const LANG = {
  es:{
    ...
    help_remote_setting_hint:"No cambia las respuestas normales. Solo permite pedir más ayuda cuando la guía local no basta, para que OpenAI elija otra guía. Recibe solo la pregunta escrita; nunca saldos ni movimientos. Puedes revocar este permiso aquí.",
  ...
  en:{
    ...
    help_remote_setting_hint:"Does not change normal answers. It only lets you ask for more help when the local guide is unsure, so OpenAI can pick another guide. It receives only the written question, never balances or transactions. You can revoke this permission here.",
  ...
  ca:{
    ...
    help_remote_setting_hint:"No canvia les respostes normals. Només permet demanar més ajuda quan la guia local no basta, perquè OpenAI triï una altra guia. Rep només la pregunta escrita; mai saldos ni moviments. Pots revocar aquest permís aquí.",
