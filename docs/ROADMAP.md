...
> Estado a 2026-09-26 · **v4.26.51** candidata a producción FIN-06 aprobada: originales/ISO, total incompleto y 30 divisas. Producción actual 4.26.48, beta 4.26.51.1. APK de producción 4.26.32/code 48 intacta. FIN-05 y selector quedan en beta; backend sin desplegar.
...
| Qué | Valor |
|-----|--------|
| Web / OTA (`VERSION`) | **4.26.51** candidata aprobada; producción todavía 4.26.48; beta 4.26.51.1. |
